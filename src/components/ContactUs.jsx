...
const ContactUs = () => {
    ...
    formData.append("access_key", "44910bec-03b8-4e97-bc48-9be795cd892e");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      <Title title='Reach out to us' desc='From strategy to execution, we craft digital solutions that move your bussiness forward.'/>
      <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
        ...
        <div className='sm:col-span-2'>
            ...
            <textarea name="message" rows={8} placeholder='Enter your message' className='w-full text-sm p-3 outline-none rounded-lg 
            border border-gray-300 dark:border-gray-600' required/>
        </div>
